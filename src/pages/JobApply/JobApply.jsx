    ...
    <div>
      ...
      <h3 className="text-2xl">Applying for Job: <Link className="link link-primary" to={`/jobs/${jobId}`}>Details</Link> </h3>
        ...
        <div>
          ...
          <input type="url" name="linkedIn" className="input w-80" placeholder="linkedIn profile link" />
        </div>
        <div>
          <label className="label">Github Profile</label> <br />
          <input type="url" name="github" className="input w-80" placeholder="github profile link" />
        </div>
        <div>
          <label className="label">Resume</label> <br />
          <input type="text" name="resume" className="input w-80" placeholder="resume link" />
        </div>
